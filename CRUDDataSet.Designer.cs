...
namespace CRUD_produtos.CRUDDataSetTableAdapters {
    ...
    public partial class ProdutosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Produtos] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Preco = 1 AND [Preco] IS NULL) OR ([Preco] = @Original_Preco)) AND ((@IsNull_Quantidade = 1 AND [Quantidade] IS NULL) OR ([Quantidade] = @Original_Quantidade)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Produtos] ([Nome], [Preco], [Quantidade]) VALUES (@Nome, @Prec" +
                "o, @Quantidade);\r\nSELECT Id, Nome, Preco, Quantidade FROM Produtos WHERE (Id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Produtos] SET [Nome] = @Nome, [Preco] = @Preco, [Quantidade] = @Quantidade WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_Preco = 1 AND [Preco] IS NULL) OR ([Preco] = @Original_Preco)) AND ((@IsNull_Quantidade = 1 AND [Quantidade] IS NULL) OR ([Quantidade] = @Original_Quantidade)));
SELECT Id, Nome, Preco, Quantidade FROM Produtos WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_produtos.Properties.Settings.Default.CRUDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, Preco, Quantidade FROM dbo.Produtos";
        ...
        public virtual int Fill(CRUDDataSet.ProdutosDataTable dataTable) {
        ...
        public virtual CRUDDataSet.ProdutosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CRUDDataSet.ProdutosDataTable dataTable = new CRUDDataSet.ProdutosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CRUDDataSet.ProdutosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, global::System.Nullable<decimal> Original_Preco, global::System.Nullable<int> Original_Quantidade) {
        ...
        public virtual int Insert(string Nome, global::System.Nullable<decimal> Preco, global::System.Nullable<int> Quantidade) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, global::System.Nullable<decimal> Preco, global::System.Nullable<int> Quantidade, int Original_Id, string Original_Nome, global::System.Nullable<decimal> Original_Preco, global::System.Nullable<int> Original_Quantidade, int Id) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, global::System.Nullable<decimal> Preco, global::System.Nullable<int> Quantidade, int Original_Id, string Original_Nome, global::System.Nullable<decimal> Original_Preco, global::System.Nullable<int> Original_Quantidade) {
            return this.Update(Nome, Preco, Quantidade, Original_Id, Original_Nome, Original_Preco, Original_Quantidade, Original_Id);
        }
    }
